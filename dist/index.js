...
const Range = __webpack_require__(263)
...
const compare = __webpack_require__(255)
...
const { MAX_LENGTH, MAX_SAFE_INTEGER } = __webpack_require__(294)
const { re, t } = __webpack_require__(595)

const { compareIdentifiers } = __webpack_require__(631)
class SemVer {
...
var command_1 = __webpack_require__(591);
var dependencies_1 = __webpack_require__(790);
...
var core_1 = __importDefault(__webpack_require__(51));
try {
    ...
    var run = core_1.default.getInput("run");
    var params = core_1.default.getInput("params");
...
var version_1 = __importDefault(__webpack_require__(859));
...
const outside = __webpack_require__(410)
...
var yaml = __webpack_require__(827);
...
const Comparator = __webpack_require__(409)
const debug = __webpack_require__(846)
const SemVer = __webpack_require__(94)
const {
  re,
...
var DEFAULT_SAFE_SCHEMA = __webpack_require__(945);
...
const gt = __webpack_require__(592)
const lt = __webpack_require__(795)
const lte = __webpack_require__(694)
const gte = __webpack_require__(615)
...
const compareBuild = __webpack_require__(61)
...
var relation_1 = __webpack_require__(218);
...
var UniversalPkg = /** @class */ (function () {
    ...
    UniversalPkg.prototype.removeInvalidDependencies = function () {
        ...
        for (var _i = 0, _a = this.dependencies; _i < _a.length; _i++) {
            var _b = _a[_i], pkg = _b[0], versionRelation = _b[1];
            for (var _c = 0, versionRelation_1 = versionRelation; _c < versionRelation_1.length; _c++) {
                var version = versionRelation_1[_c][0];
                if (!this.isValid(pkg, version)) {
                    invalidDep.push([pkg, version]);
                }
            }
        }
        for (var _d = 0, invalidDep_1 = invalidDep; _d < invalidDep_1.length; _d++) {
            var _e = invalidDep_1[_d], pkg = _e[0], version = _e[1];
    ...
    UniversalPkg.prototype.isValid = function (pkg, version) {
        ...
        for (var _i = 0, depended_1 = depended; _i < depended_1.length; _i++) {
            var _a = depended_1[_i], dependedPkg = _a[0], dependedVersion = _a[1];
    ...
    UniversalPkg.prototype.uninstall = function (pkg, version, isDep) {
        ...
        if (depended && depended.size > 0) {
            ...
            for (var _i = 0, depended_2 = depended; _i < depended_2.length; _i++) {
                var _a = depended_2[_i], dependedPkg = _a[0], dependedVersion = _a[1];
        ...
        if (dependencies) {
            for (var _b = 0, dependencies_1 = dependencies; _b < dependencies_1.length; _b++) {
                var _c = dependencies_1[_b], requiredPkg = _c[0], requiredVersion = _c[1];
...
var Command = /** @class */ (function () {
    function Command(ctx, pluginPath, command) {
        ...
        this.binPath = path_1.default.join(pluginPath, '.bin');
        var osArchCommands = command === null || command === void 0 ? void 0 : command[base_1.platformType + "." + base_1.arch];
        var osCommands = command === null || command === void 0 ? void 0 : command[base_1.platformType];
        var defaultCommands = command === null || command === void 0 ? void 0 : command.default;
        if (osArchCommands) {
            this.commands = base_1.toArray(osArchCommands);
        }
        else if (osCommands) {
            this.commands = base_1.toArray(osCommands);
        }
        else if (defaultCommands) {
            this.commands = base_1.toArray(defaultCommands);
        }
        this.ctx = ctx;
    }
    ...
    Command.prototype.run = function () {
        ...
        var envPath = "" + this.binPath + path_1.default.delimiter + process.env['PATH'];
        // 准入依赖path
...
const { MAX_SAFE_COMPONENT_LENGTH } = __webpack_require__(294)
const debug = __webpack_require__(846)
...
const {MAX_LENGTH} = __webpack_require__(294)
const { re, t } = __webpack_require__(595)
const SemVer = __webpack_require__(94)
...
var base_1 = __webpack_require__(960);
var lookpath_1 = __webpack_require__(715);
var Dependencies = /** @class */ (function () {
    function Dependencies(dep) {
        this.os = base_1.toArray(dep === null || dep === void 0 ? void 0 : dep.os);
        this.command = base_1.toArray(dep === null || dep === void 0 ? void 0 : dep.command);
        this.plugin = base_1.toArray(dep === null || dep === void 0 ? void 0 : dep.plugin);
    }
    ...
    Dependencies.prototype.checkOs = function () {
        ...
        var i = this.os.findIndex(function (cur) {
    ...
    Dependencies.prototype.checkCommand = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, command, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _i = 0, _a = this.command;
                        _b.label = 1;
                    case 1:
...
var loader = __webpack_require__(288);
var dumper = __webpack_require__(684);
...
module.exports.Type                = __webpack_require__(532);
module.exports.Schema              = __webpack_require__(897);
module.exports.FAILSAFE_SCHEMA     = __webpack_require__(189);
module.exports.JSON_SCHEMA         = __webpack_require__(692);
module.exports.CORE_SCHEMA         = __webpack_require__(308);
module.exports.DEFAULT_SAFE_SCHEMA = __webpack_require__(945);
module.exports.DEFAULT_FULL_SCHEMA = __webpack_require__(279);
...
module.exports.YAMLException       = __webpack_require__(515);

// Deprecated schema names from JS-YAML 2.0.x
module.exports.MINIMAL_SCHEMA = __webpack_require__(189);
module.exports.SAFE_SCHEMA    = __webpack_require__(945);
module.exports.DEFAULT_SCHEMA = __webpack_require__(279);
...
Object.defineProperty(exports, "__esModule", { value: true });
var semver_1 = __importDefault(__webpack_require__(922));
...
const eq = __webpack_require__(203)
const neq = __webpack_require__(590)
const gt = __webpack_require__(592)
const gte = __webpack_require__(615)
const lt = __webpack_require__(795)
const lte = __webpack_require__(694)
...
var fs_1 = __importDefault(__webpack_require__(747));
var js_yaml_1 = __importDefault(__webpack_require__(241));
...
const internalRe = __webpack_require__(595)
module.exports = {
  re: internalRe.re,
  src: internalRe.src,
  tokens: internalRe.t,
  SEMVER_SPEC_VERSION: __webpack_require__(294).SEMVER_SPEC_VERSION,
  SemVer: __webpack_require__(94),
  compareIdentifiers: __webpack_require__(631).compareIdentifiers,
  rcompareIdentifiers: __webpack_require__(631).rcompareIdentifiers,
  parse: __webpack_require__(754),
  valid: __webpack_require__(93),
  clean: __webpack_require__(251),
  inc: __webpack_require__(491),
  diff: __webpack_require__(952),
  major: __webpack_require__(873),
  minor: __webpack_require__(966),
  patch: __webpack_require__(803),
  prerelease: __webpack_require__(37),
  compare: __webpack_require__(255),
  rcompare: __webpack_require__(73),
  compareLoose: __webpack_require__(826),
  compareBuild: __webpack_require__(61),
  sort: __webpack_require__(769),
  rsort: __webpack_require__(422),
  gt: __webpack_require__(592),
  lt: __webpack_require__(795),
  eq: __webpack_require__(203),
  neq: __webpack_require__(590),
  gte: __webpack_require__(615),
  lte: __webpack_require__(694),
  cmp: __webpack_require__(876),
  coerce: __webpack_require__(900),
  Comparator: __webpack_require__(409),
  Range: __webpack_require__(263),
  satisfies: __webpack_require__(15),
  toComparators: __webpack_require__(417),
  maxSatisfying: __webpack_require__(855),
  minSatisfying: __webpack_require__(763),
  minVersion: __webpack_require__(653),
  validRange: __webpack_require__(996),
  outside: __webpack_require__(410),
  gtr: __webpack_require__(240),
  ltr: __webpack_require__(985),
  intersects: __webpack_require__(202),
  simplifyRange: __webpack_require__(498),
  subset: __webpack_require__(954),
}
...
const Range = __webpack_require__(263)
const { ANY } = __webpack_require__(409)
const satisfies = __webpack_require__(15)
const compare = __webpack_require__(255)
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.toArray = exports.arch = exports.platformType = void 0;
var os_1 = __importDefault(__webpack_require__(87));
var platformMap = {
    aix: 'linux',
    freebsd: 'linux',
...
exports.arch = arch;
var platformType = platformMap[platform] ? platformMap[platform] : platform;
exports.platformType = platformType;
function toArray(v, defaultV) {
